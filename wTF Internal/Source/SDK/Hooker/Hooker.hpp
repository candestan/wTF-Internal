...
namespace DirectXHooker {
	...
	namespace Originals {
		extern WNDPROC oWindowProc;
		extern std::add_pointer_t<HRESULT STDMETHODCALLTYPE(IDirect3DDevice9*, const RECT*, const RECT*, HWND, const RGNDATA*)> DXPresent;
		extern std::add_pointer_t<HRESULT STDMETHODCALLTYPE(IDirect3DDevice9*, D3DPRESENT_PARAMETERS*)> DXReset;
	}
	BOOL Install();
	VOID Uninstall();
}