...
public:
	...
	virtual const char* Key_BindingForKey(uint32_t& code) = 0;

	// key trapping (for binding keys)
	virtual void				StartKeyTrapMode(void) = 0;
	virtual bool				CheckDoneKeyTrapping(uint32_t& code) = 0;
...
public:
	...
	virtual int				IN_KeyEvent(int eventcode, uint32_t keynum, const char* pszCurrentBinding) = 0;
...
#ifdef _WIN32
	virtual void			StartStatsReporting(uintptr_t handle, bool bArbitrated) = 0;
#endif
